...
namespace IngameScript
{
    ...
    {
        public class ProjectorProjection
        {
            IMyProjector projector;
            Vector3I projectionSize;

            public ProjectorProjection(IMyProjector projector, Vector3I projectionSize)
            {
                this.projector = projector;
                this.projectionSize = projectionSize;
            }

            public void UpdateProjection(Vector3D locationInWorld)
            {
                ...
                locationInGrid -= (Vector3D)projectionSize / 2;
